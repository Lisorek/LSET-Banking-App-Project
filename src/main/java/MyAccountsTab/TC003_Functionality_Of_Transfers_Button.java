...
public class TC003_Functionality_Of_Transfers_Button {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            if (fdriver.getCurrentUrl().equals("http://lsetbank.lset.uk/myaccounts/transfer")) {
                System.out.println("Transfers Tab works");
                System.out.println("Test Successful");
            } else {
                System.out.println(fdriver.getCurrentUrl());
                System.out.println("Transfers Tab doesn't work");
