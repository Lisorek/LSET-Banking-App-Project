...
public class TC008_Use_Letters_Instead_Of_Numbers {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("After providing letters to Sort code field, Error displayed under it says: " + errorPopUp.getText());
