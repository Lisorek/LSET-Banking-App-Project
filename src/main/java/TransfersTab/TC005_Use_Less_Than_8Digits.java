...
public class TC005_Use_Less_Than_8Digits {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            if (errorPopUp.getText().equals("")) {
                ...
                System.out.println("After providing too short (6 digits) Account number, Error displayed under it says: " + errorPopUp.getText());
