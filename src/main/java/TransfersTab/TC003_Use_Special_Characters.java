...
public class TC003_Use_Special_Characters {
    public static void main(String[] args) throws InterruptedException {
        ...
        accountNumber.sendKeys("!@~");
        submitButton.click();


        try {
            WebElement errorPopUp = fdriver.findElement(By.xpath("/html/body/div/main/div/div/form/div[1]/div"));
            System.out.println("After providing value: (!@~) to Account number, Error displayed under it says: " + errorPopUp.getText());
