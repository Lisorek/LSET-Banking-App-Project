...
public class TC002_Use_Letters_Instead_Of_Numbers {
    public static void main(String[] args) throws InterruptedException {
        ...
        accountNumber.sendKeys("abcd");
        submitButton.click();


        try {
            WebElement errorPopUp = fdriver.findElement(By.xpath("/html/body/div/main/div/div/form/div[1]/div"));
            System.out.println("After providing value: (abcd) to Account number, Error displayed under it says: " + errorPopUp.getText());
