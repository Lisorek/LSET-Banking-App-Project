...
public class TC013_Use_Letters_Instead_Of_Numbers_AmountField {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("After providing letters to Amount field, Error displayed under it says: " + errorPopUp.getText());
