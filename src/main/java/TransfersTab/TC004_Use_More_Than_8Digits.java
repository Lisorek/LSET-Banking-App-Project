...
public class TC004_Use_More_Than_8Digits {
    public static void main(String[] args) throws InterruptedException {
        ...
        accountNumber.sendKeys("1234567891");
        ...
        try {
            ...
            System.out.println("After providing too long (10 digits) Account number, Error displayed under it says: " + errorPopUp.getText());
