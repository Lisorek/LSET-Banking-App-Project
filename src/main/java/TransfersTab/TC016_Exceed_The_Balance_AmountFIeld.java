...
public class TC016_Exceed_The_Balance_AmountFIeld {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("After exceeding available amount, Error displayed under it says: " + errorPopUp.getText());
