...
public class TC009_Use_Special_Characters_SortCode {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("After providing special characters to Sort code field, Error displayed under it says: " + errorPopUp.getText());
