...
public class TC023_Password_Button_Works_with_long_Passwords {
    public static void main(String[] args) throws InterruptedException {
        ...
        passwordField.sendKeys("abcdefgh1234&%j7yb-q");
        confirmPasswordField.sendKeys("abcdefgh1234&%j7yb-q");
