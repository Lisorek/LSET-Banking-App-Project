...
public class TC007_Username_Is_Invalid_email {
    public static void main(String[] args) throws InterruptedException {
        ...
        usernameField.sendKeys("olga..@example.com");
        passwordField.sendKeys("uT01N8*.");
        confirmPasswordField.sendKeys("uT01N8*.");
        emailField.sendKeys("olga..@example.com");
        signUpButton2.click();
        Thread.sleep(1000);
