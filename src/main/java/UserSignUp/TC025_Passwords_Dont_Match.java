...
public class TC025_Passwords_Dont_Match {
    public static void main(String[] args) throws InterruptedException {
        ...
        confirmPasswordField.sendKeys("xyz*987");
        ...
        try {
            WebElement errorPopUp = fdriver.findElement(By.xpath("/html/body/div/main/div/form/div[3]/div"));
